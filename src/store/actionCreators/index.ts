...
// import { Action, ActionTypes, FailurePayload } from '../../types/state';
import {
  authTokenName,
  // requestTimeout,
} from '../../constants';
...
// */
// export const generateSuccessPayload = (response: AxiosResponse, customParams = {}, subField = ''): Action['payload'] => {
