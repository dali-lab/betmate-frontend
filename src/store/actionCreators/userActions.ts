...
export const fetchUserById = (...args: any) => { };
export const updateUserById = (...args: any) => { };
export const deleteUserById = (...args: any) => { };
export const fetchAllUsers = (...args: any) => { };

// import { User } from '../../types/auth';
// import { ThunkResult } from '../../types/state';
// import { getBearerTokenHeader } from '.';
